...
export default function ProjectCard ({name, description, githubLink, link,status,tools})
{
    return(
        <div className="my-5 px-5 border-l-2 border-gray-400">
            <h1 className="text-xl">{name}</h1>
            <div className="flex flex-row gap-3">
            <a className="mt-2 text-slate-600 flex flex-row items-center" target="__blank" href={link}>Live Preview<div className="w-4 h-4"> <LinkArrow/></div></a>
