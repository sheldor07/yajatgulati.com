...
export default function Header(){
    return(
        ...
        Feel free to get in touch via <a className="link-higlight"href="">Email</a> or <a className="link-highlight"href="https://www.linkedin.com/in/yajat-gulati-b4a7411bb/">LinkedIn</a>
        </div>
    </div>
    )
